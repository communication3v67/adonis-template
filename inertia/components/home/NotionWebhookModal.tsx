...
import { LuBadgeAlert, LuCheck, LuChevronDown, LuSend, LuX } from 'react-icons/lu'
            ...
            <Stack gap="lg">
                ...
                >
                    {isError
                        ...
                        : type === 'bulk'
                          ? `${itemsCount} page(s) a(ont) été envoyée(s) avec succès vers n8n et sera(ont) traitée(s) sous peu.`
                ...
                {isReloading && (
                    <Alert color="green" variant="light" radius="md">
                        <Group gap="xs">
                            <Loader color="green" size={16} />
                            <Text size="sm">Rechargement de la page en cours...</Text>
                        </Group>
                    </Alert>
                )}
                    ...
                    <Alert color="green" variant="light" radius="md">
                        <Stack gap="xs">
                            ...
                            <Text size="sm">
                                {type === 'bulk' ? (
                                    <>
                                        • {itemsCount} page(s) Notion sont en cours de traitement
                                        par n8n
                                        <br />
                                        • Le workflow va générer les titres des posts GMB
                                        correspondants
                                        <br />
                                        • Vous pouvez suivre l'avancement dans la section Mes Posts
                                        <br />• Les pages traitées disparaîtront de la liste des
                                        opérations en attente après rafraîchissement de la page.
                                    </>
                                ) : (
                                    <>
                                        • Votre page Notion est en cours de traitement par n8n
                                        <br />
                                        • Le workflow va générer le titre GMB correspondant
                                        <br />• La page traitée disparaîtra de la liste des
                                        opérations en attente après rafraîchissement de la page.
                                    </>
                                )}
                            </Text>
                ...
                <Group justify="space-between">
                    ...
                    <Group ml="auto">
                        ...
                        >
                            {isReloading ? 'Rechargement...' : isError ? 'Fermer' : 'Parfait !'}
                        </Button>
                    </Group>
                </Group>
            </Stack>
