...
export const FilterRowComponent = ({
    filter,
    properties,
    onUpdate,
    onRemove,
            ...
            case 'date':
                    ...
                    return (
                        <Group gap="xs" flex={1}>
                            <DatePickerInput
                                ...
                                value={betweenValue.from ? new Date(betweenValue.from) : null}
                            ...
                            <DatePickerInput
                                ...
                                value={betweenValue.to ? new Date(betweenValue.to) : null}
                                onChange={(date) => handleValueChange({
                                    ...betweenValue,
                ...
                return (
                    <DatePickerInput
                        ...
                        onChange={(date) => handleValueChange(date ? date.toISOString().split('T')[0] : '')}
                        flex={1}
                        clearable
                    />
                )
